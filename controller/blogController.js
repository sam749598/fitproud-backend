...
//       if (req.files) {
//         const filePaths = [];
//         if (req.files.thumbnail) filePaths.push(req.files.thumbnail[0].path);
//         if (req.files.extraImages)
//           filePaths.push(...req.files.extraImages.map((f) => f.path));
//         if (req.files.videos)
//           filePaths.push(...req.files.videos.map((f) => f.path));
...
//     const thumbnail = req.files?.thumbnail?.[0]?.path || blog.thumbnail;
//     const extraImages =
//       req.files?.extraImages?.map((file) => file.path) || blog.extraImages;
//     const videos =
//       req.files?.videos?.map((file) => file.path) || blog.videos;
